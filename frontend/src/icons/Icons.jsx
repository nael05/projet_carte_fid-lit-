...
export const LogOut = ({ size = 24, className = "" }) => (
  <svg
    ...
    className={className}
  >
    <path d="M17 16l4-4m0 0l-4-4m4 4H7m0 0a4 4 0 0 0 0 8h4m-8-8a4 4 0 0 1 0-8h4"></path>
  </svg>
);
...
export const Settings = ({ size = 24, className = "" }) => (
  ...
  >
    <circle cx="12" cy="12" r="3"></circle>
    <path d="M12 1v6m0 6v6M4.22 4.22l4.24 4.24m3.08 3.08l4.24 4.24M1 12h6m6 0h6m-4.22-7.78l-4.24-4.24M7.46 11.54L3.22 7.3M19.78 19.78l-4.24-4.24m-3.08-3.08l-4.24-4.24"></path>
  </svg>
);
